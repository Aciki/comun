  ...
  <div id="wrapper">
    <nav class="navbar is-primary">
      <div class="navbar-brand">
        <router-link to="/" class="navbar-item"><strong>ЈКП "Комуналец" Демир Хисар</strong></router-link>
          ...
          <div class="navbar-item">
            <div class="buttons">
              <template v-if="$store.state.isAuthenticated">
                <router-link to="/my-account" class="button is-light">ПРОФИЛ</router-link>
              </template>
